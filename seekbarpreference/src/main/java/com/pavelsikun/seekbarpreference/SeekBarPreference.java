...
public class SeekBarPreference extends Preference implements View.OnClickListener, PreferenceControllerDelegate.ViewStateListener, PersistValueListener, ChangeValueListener {
    ...
    private void init(AttributeSet attrs) {
        ...
        controllerDelegate = new PreferenceControllerDelegate(getContext(), false, getTitle().toString());
    ...
    public boolean getImperial() { return controllerDelegate.getImperial(); }

    public void setImperial(boolean imperial) { controllerDelegate.setImperial(imperial); }
    ...
    public String getMeasurementUnitImperial() {
        return controllerDelegate.getMeasurementUnitImperial();
    }
    ...
    public void setMeasurementUnitImperial(String measurementUnit) {
        controllerDelegate.setMeasurementUnitImperial(measurementUnit);
    }
