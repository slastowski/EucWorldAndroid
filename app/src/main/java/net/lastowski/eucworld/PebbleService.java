...
import net.lastowski.eucworld.utils.Constants.PEBBLE_APP_SCREEN;
...
import static net.lastowski.eucworld.utils.Constants.PEBBLE_APP_SCREEN.DETAILS;
import static net.lastowski.eucworld.utils.Constants.PEBBLE_APP_SCREEN.GUI;
...
public class PebbleService extends Service {
    ...
    BroadcastReceiver receiver = new PebbleBroadcastReceiver();
    ...
    private Runnable mSendPebbleData = new Runnable() {
        ...
        public void run() {
            ...
            if (refreshAll) {
                outgoingDictionary.addInt32(KEY_USE_MPH, SettingsUtil.isUseMi(PebbleService.this) ? 1 : 0);
    ...
    private int alarmCompat(int eucWorldAlarm) {
        switch (eucWorldAlarm) {
            case 0:
            case 1:
            case 2:
                return 0;
            ...
            switch (intent.getAction()) {
                case Constants.ACTION_ALARM_TRIGGERED:
                    if (intent.hasExtra(Constants.INTENT_EXTRA_ALARM_TYPE))
                        vibe_alarm = alarmCompat(((Constants.ALARM_TYPE) intent.getSerializableExtra(Constants.INTENT_EXTRA_ALARM_TYPE)).getValue());
                    break;
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        intentFilter.addAction("com.getpebble.action.app.RECEIVE");
